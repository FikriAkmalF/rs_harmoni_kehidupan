        ...
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                <li class="sidebar-item">
                    <a href="/perawat/perawat" class="sidebar-link">
                        <i class="bi bi-bookmark"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="/perawat/data" class="sidebar-link">
                        <i class="bi bi-clipboard-data"></i>
                        <span>Data</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="/perawat/pasien" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    <a href="/perawat/jadwal" class="sidebar-link">
                        <i class="bi bi-calendar"></i>
                        <span>Jadwal</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="/perawat/riwayat_medis" class="sidebar-link">
