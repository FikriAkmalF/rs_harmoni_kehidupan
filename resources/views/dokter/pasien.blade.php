...
<body>
    ...
    <main class="content px-3 py-4">
        ...
        <div class="d-flex justify-content-between">
            ...
            <!-- Search Form -->
            <div class="search">
                <form action="{{ route('cari_nama_data_pasien') }}" method="GET" role="search" class="d-flex">
                    <input class="form-control me-2" name="cari_nama_data_pasien" type="cari_nama_data_pasien"
        ...
        @if ($message = Session::get('error'))
            <script>
                Swal.fire({
                    icon: "error",
                    title: "Aduh",
                    text: "Tidak ada nama pasien yang ditemukan!",
                });
            </script>
        @endif
